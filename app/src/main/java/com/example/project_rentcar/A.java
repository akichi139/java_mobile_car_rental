...
public class A extends Contract {
    ...
    public static final String FUNC_STORESTAMP = "storestamp";
    ...
    public RemoteFunctionCall<TransactionReceipt> buy(BigInteger num) {
    ...
    public RemoteFunctionCall<TransactionReceipt> storestamp(BigInteger num) {
        final Function function = new Function(
                FUNC_STORESTAMP, 
                Arrays.<Type>asList(new Uint256(num)),
                Collections.<TypeReference<?>>emptyList());
